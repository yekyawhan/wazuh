...
#
#   iwr https://cdn.jsdelivr.net/gh/yekyawhan/wazuh@git-home/suricata-win/build-suricata-ips.ps1 -UseBasicParsing | iex
#
...
$RepoRawBase = "https://cdn.jsdelivr.net/gh/yekyawhan/wazuh@$RepoRef/suricata-win"
