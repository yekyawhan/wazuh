...
#
#   iwr https://cdn.jsdelivr.net/gh/yekyawhan/wazuh@git-home/suricata-win/agb-full-setup-cdn.ps1 -UseBasicParsing | iex
#
...
$GitHubBase = "https://cdn.jsdelivr.net/gh/yekyawhan/wazuh@git-home/suricata-win"
